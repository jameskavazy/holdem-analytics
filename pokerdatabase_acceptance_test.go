...
func TestHandHistoriesFromFS(t *testing.T) {
	t.Run("multiple files and multiple hands returns correct number of hands", func(t *testing.T) {
		fileSystem := fstest.MapFS{
			"zoom.txt": {Data: []byte(`PokerStars Zoom Hand #254445778475:  Hold'em No Limit ($0.02/$0.05) - 2025/01/19 12:00:43 WET [2025/01/19 7:00:43 ET]
...
Seat 6: Yatoro_7 folded before Flop (didn't bet)`)},
			...
			"cash game.txt": {Data: []byte(`PokerStars Hand #254446123323:  Hold'em No Limit ($0.02/$0.05 USD) - 2025/01/19 12:38:55 WET [2025/01/19 7:38:55 ET]
...
Seat 6: pernadao1599 folded before Flop (didn't bet)`)},
	...
	t.Run("hand data is correctly parsed from a text file", func(t *testing.T) {
		fileSystem2 := fstest.MapFS{
			"Wei III": {Data: []byte(`PokerStars Hand #254446123323:  Hold'em No Limit ($0.02/$0.05 USD) - 2025/01/19 12:38:55 WET [2025/01/19 7:38:55 ET]
Table 'Wei III' 6-max Seat #1 is the button
Seat 1: maximoIV ($5.20 in chips) 
Seat 2: dlourencobss ($4.94 in chips) 
Seat 3: KavarzE ($5 in chips) 
...
`)},
		...
		handHistory, _ := pokerhud.HandHistoryFromFS(fileSystem2)
		...
		//TODO - test table so you can test singular hands still, just diff formats... 
